 ...
 class EdgeCrosser {
    ...
    /** @var int */
     ...
     public function restartAt(S2Point $c): void {
         $this->c = $c;
         $this->acb = -S2::robustCCWWithCross($this->a, $this->b, $this->c, $this->aCrossB);
     }
     ...
     public function robustCrossing(S2Point $d): int {
         ...
         $bda = S2::robustCCWWithCross($this->a, $this->b, $this->d, $this->aCrossB);
     ...
     private function robustCrossingInternal(S2Point $d): int {
         ...
         $cbd = -S2::robustCCWWithCross($this->c, $d, $this->b, $cCrossD);
         if ($cbd !== $this->acb) {
            return -1;
         }

         $dac = S2::robustCCWWithCross($this->c, $d, $this->a, $cCrossD);
