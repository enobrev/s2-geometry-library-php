...
//  }
  ...
  public function setMaxCells($maxCells) {
     ...
     * @param S2CellUnion $covering The list filled in by this method
     */
    public function getCovering(S2Region $region, S2CellUnion $covering)
    {
...
//        echo "child for " . $childCells[$i] . " is " . $child . "\n";
    ...
    private function getInitialCandidates()
    {
        ...
        if ($this->maxCells >= 4) {
            ...
            $level = min(
                S2Projections::$PROJ->minWidth->getMaxLevel(2 * $cap->angle()->radians()),
